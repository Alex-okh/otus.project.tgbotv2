...
public class UpdateData {
    ...
    public UpdateData(Update rawUpdate) {
        ...
        if (rawUpdate.message() != null && rawUpdate.message().newChatMembers() != null) {
            ...
            String fn = rawUpdate.message().newChatMembers()[0].firstName() ==
                        null ? "" : rawUpdate.message().newChatMembers()[0].firstName();
            String ln = rawUpdate.message().newChatMembers()[0].lastName() ==
                        null ? "" : rawUpdate.message().newChatMembers()[0].lastName();
            newUserName = fn + " " + ln;
            return;
        }
    ...
    private void setMessageVars(Message message) {
        ...
        userName = fn + " " + ln;
        tagUserName = message.from().username() == null ? userName : "@" + message.from().username();
    }
}
